...
%% 1. Problem Setup
fprintf('=== simulate_PTOs Optimization ===\n');

% Get boundary conditions for simulate_PTOs
...
sigma_allow = 0.1;     % Allowable von Mises stress
tau = 0.05;             % Stress tolerance band
coef_inc_dec = 0.1;    % Material increase/decrease coefficient
...
results_file = sprintf('results/ptos_3d_%dx%dx%d_%.2fstress.mat', nelx, nely, nelz, sigma_allow);
